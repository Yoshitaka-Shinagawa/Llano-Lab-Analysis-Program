...
def cell_flagger_2(path,cell_flags,dfof_data):
    ...
    for cell_number in range(cell_total):
        ...
        best_frequency,characteristic_frequency = cell_excitatory_flagger(cell_number,dfof_data,key,frequencies,decibels,0.01)
